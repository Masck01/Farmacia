...
namespace FarmaciaAvellaneda.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public AspNetUserRolesController(FarmaciaAvellanedaContext context)
        {
            _context = context;
        }
        ...
        {
            var farmaciaAvellanedaContext = _context.AspNetUserRoles.Include(a => a.Role).Include(a => a.User);
