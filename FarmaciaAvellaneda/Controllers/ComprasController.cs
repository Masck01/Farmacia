...
namespace FarmaciaAvellaneda.Controllers
{
    ...
    public class ComprasController : Controller
    {
        ...
        public ComprasController(FarmaciaAvellanedaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,Total")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,Total")] Compra compra)
        {
            if (id != compra.Id)
            {
                return NotFound();
